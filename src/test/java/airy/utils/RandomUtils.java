...
public class RandomUtils {
    ...
    public static String getRandomString(int length) {
        //берутся символы из SALTCHARS и выводится текст длиной length, которую указываем в методе.
...
//создание рандомного сообщения. Указать минимальное и максимальное количество символов.
    ...
    public static String randomGender() {
        ...
        int pos = rInt.nextInt(gender.length);
        return gender[pos];
    }
    ...
    public static String randomMonth() {
        ...
        Random rInt = new Random();
        int pos = rInt.nextInt(month.length);
        return month[pos];
    }

    public static int maxDayInMonth(String month) {
...
// генерация рандомного числа
    ...
    public static String yearBirthString() {
        return getRandomInt(1900, 2100) + "";
    }
...
// так как int ограничен по длине числа, то для длинных чисел метод ниже
